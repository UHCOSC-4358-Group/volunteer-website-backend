...
from ..models.models import EventCreate, Event, UrgencyLevel
from ..dependencies.auth import get_current_user, UserTokenInfo
...
async def delete_event(
    event_id: str, user_id: UserTokenInfo = Depends(get_current_user)
): ...
